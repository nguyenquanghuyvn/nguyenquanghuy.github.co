...
This creates a simple but often overlooked problem: **why should the informed farmer share valuable information for free?** If the information helps another farmer earn more, the two farmers may be able to negotiate over how to divide that additional gain.
...
Participants were paired. One farmer, called the **leader**, received information about the technology state. The other, called the **follower**, initially made decisions without knowing which state applied. When the leader's information could improve the follower's payoff, it created an **information surplus**: the extra money available because the follower could make a better-informed decision.

The two farmers then decided whether to bargain. When both agreed, they negotiated how to divide this surplus.
...
Most negotiations were also short. Nearly **72% of agreements were reached after the leader's first proposal**, and the typical negotiation required only one proposal.

The gains were usually shared around the middle. The informed farmer received, on average, **50.3% of the surplus**, while the median agreement was an exact 50--50 split. An equal division was chosen in about **48% of all agreements**, and around **60%** were within five percentage points of equality.
...
When organic technology performed well, better information encouraged followers to allocate more land to organic production. When it performed poorly, the same information led them to reduce their organic allocation. Across successful agreements, the estimated improvement in decision quality generated about **2.15 million Vietnamese dong** in additional experimental earnings.
...
Our findings suggest that information sharing may work better when the incentives of both sides are considered. Possible approaches include compensating peer trainers, recognizing demonstration farmers' contributions, or designing cooperative arrangements in which the benefits created by shared knowledge are distributed transparently.
